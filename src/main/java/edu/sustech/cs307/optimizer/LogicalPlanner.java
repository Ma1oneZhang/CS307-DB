...
public class LogicalPlanner {
    public static LogicalOperator resolveAndPlan(DBManager dbManager, String sql) throws DBException {
        ...
        // functional
            ...
            DropTableExecutor dropTableExecutor = new DropTableExecutor(dropStmt, dbManager);
            ...
            ShowTableExecutor showTableExecutor = new ShowTableExecutor(showTablesStatement, dbManager);
